...
| `daily_market_flow` | TWSE BFI82U / TPEx amount summary, TWSE T86 / TPEx three-institution detail, TWSE/TPEx margin balances, and weekly TDCC holder distribution | Each trading day after the aligned official daily feeds; TDCC comparison advances weekly | Max 2 calendar-day lag for daily feeds; latest complete TDCC pair is retained | None; fail closed when a required source partition is unavailable | Homepage publishes exact official monetary totals; dedicated Top 50 rankings add 200-lot-or-less weekly holding-ratio reduction, margin-balance change, and short-to-margin ratio without inventing missing values |
