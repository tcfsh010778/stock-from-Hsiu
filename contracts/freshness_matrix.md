...
| `weekly_holder_risers` | Derived from the latest two weekly `holding_shares` snapshots | Weekly after holder refresh | Max 10 calendar days | None; cache state visible | Lists every positive change in the 400+ lots major-holder ratio without a Top N cap; this is an observation filter, not a buy signal |
