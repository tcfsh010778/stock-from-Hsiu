...
| `weekly_holder_risers` | Derived from seven aligned weekly snapshots; ongoing compact 400+ lot aggregates come from TDCC OpenAPI | Weekly after holder refresh | Max 10 calendar days | Legacy normalized history, visibly identified | Lists every latest-week positive change and its six week-over-week deltas without a Top N cap; incomplete six-week history stays visible and this is not a buy signal |
