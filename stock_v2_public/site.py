...
V2_CSS += r'''.latest-btn{border:1px solid var(--line);background:#172235;color:#cbd6e5;border-radius:4px;padding:3px 9px;cursor:pointer}.latest-btn:hover,.latest-btn:focus{border-color:var(--cyan);color:white}.annotation-note{color:#b8c7da}.annotation-note b{color:#e8eef8}'''
