...
- This section supersedes the historical union/62-row descriptions below. Pure private implementation d3441cd1a5fd2b3780af1b7b4d3c927411045403 is mirrored here; private-only notification queue correction is bd52ec83025a0c4ba6ea11cc3b9f8ae65e14bf44. TDCC integration is 8a373cc2; regenerated workspace is 21056007.
...
- Public focused tests: 53 passed; private: 76 plus 5 subtests. Private CI 34495412781 passes Linux/Windows with 391 tests plus 19 subtests each. Public source CI 34493213141 passes Linux/Windows with 40 unittest, 276 pytest and 4 subtests each. New PRs bypass the 300-file path-filter limitation so generated artifacts cannot hide source changes from CI. Read-only review found no remaining blocker after clear-record, state-version and obsolete queued-event fixes.
...
- Final cloud update dry-run is 34495537819, testing the producer at 8a373cc2 with no publication. Exact outcome and final-head CI results are recorded in Issue35 and the linked run. A later cloud roster may have 1,975 securities; do not combine that index with the earlier internally consistent local preview.
