...
class TdccHolderSnapshotTests(unittest.TestCase):
    ...
    def test_aggregate_keeps_compact_major_and_retail_200_metrics_for_known_markets(self):
        raw = [
            {"\ufeff資料日期": "20260807", "證券代號": "2330", "持股分級": "1", "人數": "90", "占集保庫存數比例%": "1.50"},
            {"\ufeff資料日期": "20260807", "證券代號": "2330", "持股分級": "10", "人數": "19", "占集保庫存數比例%": "4.50"},
        ...
        self.assertEqual(snapshot["rows"][0]["retail_200_percent"], 6.0)
